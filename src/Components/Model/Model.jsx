...
import './Model.css';*/
/*
API Key: 36b6a054e0c294b63dc8
API Secret: e17d9567bfae524f7f7cc2c4a9987faed556ea6766471c628daf7432ea2876ae
JWT: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..mCuTmFcV0b7zGWVX6h1gJSE3vFkd_prv-TwKrv_VrgQ
*/
/*
const Model = () => {
    ...
    const uploadMetadataToPinata = async (name, address, imageUrl) => {
        ...
        try {
            ...
            const data = await res.json();
            console.log("I am here", data.IpfsHash);
